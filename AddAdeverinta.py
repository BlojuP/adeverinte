...
def addAdev(): 
 ...
 #Frame1               
    ...
    labelFrame.place(relx=0.1,rely=0.45,relwidth=0.5,relheight=0.4)
    ...
    adevInfo1.place(relx=0.3 ,rely=0.10, relwidth=0.62, relheight=0.08)
    ...
    adevInfo2.place(relx=0.3,rely=0.25, relwidth=0.62, relheight=0.08)
    ...
    adevInfo3.place(relx=0.3,rely=0.40, relwidth=0.62, relheight=0.08)
    ...
    adevInfo4.place(relx=0.3,rely=0.55, relwidth=0.62, relheight=0.08)
    ...
    adevInfo5 = dt
    adevInfo5.place(relx=0.3,rely=0.70, relwidth=0.62, relheight=0.08)
    ...
    adevInfo6 = expira1
    adevInfo6.place(relx=0.3,rely=0.85, relwidth=0.62, relheight=0.08)

#Frame2
    labelFrame2 = Frame(root,bg='black')
    labelFrame2.place(relx=0.6,rely=0.45,relwidth=0.27,relheight=0.4)
    today = date.today()
    cal = Calendar(labelFrame2, selectmode="day", year=today.year, month=today.month, day=today.day)
    cal.place(relx=0.05,rely=0.04, relheight=0.8) 
    ...
    my_button.place(relx=0.35,rely=0.87)

    my_label = Label(labelFrame2, text="")
    #my_label.place(relx=0.3,rely=0.70, relwidth=0.62, relheight=0.08)
    my_sixlabel = Label(labelFrame2, text= "")
    #my_sixlabel.place(relx=0.3,rely=0.85, relwidth=0.62, relheight=0.08)
